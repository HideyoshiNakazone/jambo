...
class StringTypeParser(GenericTypeParser):
    ...
    format_type_mapping: ClassVar[dict[str, type]] = {
        "email": EmailStr,
        "uri": HttpUrl,
        "ipv4": IPvAnyAddress,
        "ipv6": IPvAnyAddress,
    ...
    format_pattern_mapping: ClassVar[dict[str, str]] = {
        "hostname": r"^[a-zA-Z0-9]([a-zA-Z0-9\-]{0,61}[a-zA-Z0-9])?(\.[a-zA-Z0-9]([a-zA-Z0-9\-]{0,61}[a-zA-Z0-9])?)*$",  # noqa
    }
